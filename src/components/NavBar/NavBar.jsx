...
export const NavBar = () => {
    ...
    return (
        <>
            {!isTabletOrMobile ? <div className={styles.fixContainer}>
                <div className={styles.container}>
                    ...
                    <form className={styles.form} onSubmit={handleSubmit}>
                        ...
                        <input className={styles.input} value={searchInput} onChange={(e) => { setSearchInput(e.target.value) }} />
                        <button style={{ display: 'none' }} type="submit"></button>
                    </form>
                    <div className={styles.selector}>
                        <NavLink className={({ isActive }) => isActive ? `${styles.navLink_active}` : `${styles.navLink}`} to='/' >ALL</NavLink>
                        <NavLink className={({ isActive }) => isActive ? `${styles.navLink_active}` : `${styles.navLink}`} to='/myphotos'>MY PHOTOS</NavLink>
                    </div>
                </div >
            </div> : <div className={styles.fixContainer}>
                <div className={styles.container}>
